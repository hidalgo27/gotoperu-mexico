...
@section('content')
    <header>
        ...
        <div class="homepage-video">
            ...
            <iframe src="https://player.vimeo.com/video/361847703?autoplay=1&loop=1&title=0&byline=0&portrait=0&muted=1"  frameborder="0" allow="autoplay; fullscreen"></iframe>
        </div>
